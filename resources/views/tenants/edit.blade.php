...
<div class="body flex-grow-1 px-3">
  <div class="container-lg">
    ...
    <div class="card shadow p-3 mb-5 bg-body rounded" style="border:none;">
      ...
      @endif
      <div class="card-body">
        <form method="POST" action="{{ route('tenants.update', $tenant->id) }}" class="row g-3 needs-validation"
          ...
          <div class="col-md-6">
            ...
            <input type="text" class="form-control" id="contact" name="contact" value="{{ old('contact', $tenant->contact) }}" required>
            <div class="invalid-feedback">
          ...
          <div class="col-md-6">
            ...
            <input type="text" class="form-control" id="nid" name="nid" value="{{ old('nid', $tenant->nid) }}" required>
            <div class="invalid-feedback">
          ...
          <div class="col-md-6">
            ...
            <input type="text" class="form-control" id="floorNo" name="floor_no" value="{{ old('floor_no', $tenant->floor_no) }}" required>
            <div class="invalid-feedback">
          ...
          <div class="col-md-6">
            ...
            <input type="text" class="form-control" id="availableUnitNo" name="available_unit_no" value="{{ old('available_unit_no', $tenant->available_unit_no) }}" required>
            <div class="invalid-feedback">
          ...
          <div class="col-md-6">
            ...
            <input type="number" class="form-control" id="advanceRent" name="advance_rent" value="{{ old('advance_rent', $tenant->advance_rent) }}" required>
            <div class="invalid-feedback">
          ...
          <div class="col-md-6">
            ...
            <input type="number" class="form-control" id="rentPerMonth" name="rent_per_month" value="{{ old('rent_per_month', $tenant->rent_per_month) }}" required>
            <div class="invalid-feedback">
          ...
          <div class="col-md-6">
            ...
            <input type="date" class="form-control" id="issueDate" name="issue_date" value="{{ old('issue_date', $tenant->issue_date) }}" required>
            <div class="invalid-feedback">
          ...
          <div class="col-md-6">
            ...
            <input type="text" class="form-control" id="rentMonth" name="rent_month" value="{{ old('rent_month', $tenant->rent_month) }}" required>
            <div class="invalid-feedback">
          ...
          <div class="col-md-6">
            ...
            <input type="text" class="form-control" id="rentYear" name="rent_year" value="{{ old('rent_year', $tenant->rent_year) }}" required>
            <div class="invalid-feedback">
          ...
          <div class="col-md-6">
            ...
            <input type="text" class="form-control" id="status" name="status" value="{{ old('status', $tenant->status) }}" required>
            <div class="invalid-feedback">
